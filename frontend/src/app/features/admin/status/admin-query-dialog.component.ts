...
@Component({
  ...
  imports: [AdminSqlCodeEditorComponent, CopyButtonComponent, FormsModule, AdminSqlResultComponent],
  template: `
    @if (query(); as query) {
      <div
      ...
      >
        <section
          class="ee-glass grid max-h-[85vh] w-full max-w-5xl grid-rows-[auto_1fr] overflow-hidden rounded-lg"
          (click)="$event.stopPropagation()"
        >
          <header
            class="flex items-center justify-between gap-3 border-b border-white/10 p-inner-padding"
          >
            <div>
              <h2
            ...
            <div class="grid gap-4">
              <div class="grid gap-2">
                <div class="flex flex-wrap items-center justify-between gap-3">
                  <p class="ee-label text-outline">Query</p>
                  <ee-copy-button [text]="query.info ?? ''" label="Copy" ariaLabel="Copy SQL" />
                </div>
